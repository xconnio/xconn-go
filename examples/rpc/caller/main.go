...
func main() {
	...
	log.Printf("Result of procedure %s: args=%s, kwargs=%s, details=%s", testProcedureEcho, echoResult.Args,
		echoResult.KwArgs, echoResult.Details)
	...
	log.Printf("Sum=%s", sumResult.Args[0])
